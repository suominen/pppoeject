# PPPoEject — Linux kernel PPPoE use-after-free tracking site
...
Everything about the bug — the CVE ID, affected and fixed versions, upstream
...
- **Rendered:** <https://kimmo.cloud/pppoeject/>
...
distributions ship fixes — for the actively updated trackers, twice daily by
the auto-update agent — so any copy kept in this README would silently rot.
